...
\newcommand{\LabeledInclusionLL}[4]{%
\begin{tikzpicture}[scale=0.25,inner sep=.8pt,node distance=.45cm,>=latex']
\draw node [] (U1)               {#1};
\draw node [] [right of=U1] (U2) {#2};
\draw node [] [right of=U2] (U3) {#3};
\draw node [] [right of=U3] (U4) {#4};
...
\newcommand{\LabeledInclusionLR}[4]{%
\begin{tikzpicture}[scale=0.25,inner sep=.8pt,node distance=.45cm,>=latex']
\draw node [] (U1)               {#1};
\draw node [] [right of=U1] (U2) {#2};
\draw node [] [right of=U2] (U3) {#3};
...
\newcommand{\LabeledInclusionRL}[4]{%
\begin{tikzpicture}[scale=0.25,inner sep=.8pt,node distance=.45cm,>=latex']
\draw node [] (U1)               {#1};
\draw node [] [right of=U1] (U2) {#2};
\draw node [] [right of=U2] (U3) {#3};
...
\newcommand{\LabeledInclusionRR}[4]{%
\begin{tikzpicture}[scale=0.25,inner sep=.8pt,node distance=.45cm,>=latex']
\draw node [] (U1)               {#1};
\draw node [] [right of=U1] (U2) {#2};
\draw node [] [right of=U2] (U3) {#3};
...
\begin{proof}[of Lemma~\ref{lemma:matching}]
    ...
    It also avoids \InclusionLL,~\InclusionLR,~\InclusionRL and \InclusionRR.
    Indeed, suppose, aiming at a contradiction, that such a bad configuration exists
    for arcs $(i^1_j, i^2_j)$ and $(i^1_k, i^2_k)$ of $\vv{\mathcal{M}}$
    with $j < k$.
    \begin{itemize}
      \item
      \LabeledInclusionLL{$i^1_j$}{$i^1_k$}{$i^2_k$}{$i^2_j$}
      \item
      \LabeledInclusionLL{$i^1_j$}{$i^1_k$}{$i^2_k$}{$i^2_j$}
      \item
      \LabeledInclusionLL{$i^1_j$}{$i^1_k$}{$i^2_k$}{$i^2_j$}
