...
\begin{proof}[of Lemma~\ref{lemma:matching}]
    ...
    Assuming without loss of generality that $i^1_j < i^1_k$, we are 
    left with the following four configurations:
    \begin{center}
      \begin{tabular}{cccc}
    ...
    for, say,  arcs $(i^1_j, i^2_j)$ and $(i^1_k, i^2_k)$ of $\vv{\mathcal{M}}$.
    Assuming without loss of generality that $i^1_j < i^1_k$, we are 
    left with the following two configurations:
    \begin{center}
      \begin{tabular}{cccc}
    ...
    We first show that, for every $j \in [n]$,
