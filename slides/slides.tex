...
\DeclareMathOperator{\Lc}{\mathtt{c}}
\DeclareMathOperator{\Ld}{\mathtt{d}}
...
%\subtitle{
    %\includegraphics[scale=.16]{logos/CNRSfr}
    %\qquad
    %\includegraphics[scale=.10]{logos/ecole_ponts_RVB300.jpg}
    %\qquad
    %\includegraphics[scale=.26]{logos/LIGM}
    %\qquad
...
\begin{block}{{\bf Definition} (shuffle product of words)}
    The \alert{shuffle product} $\shuffle$ on words of $A^*$ is defined
    recursively by \vspace{-.5em}
    \begin{align*}
        u \shuffle \epsilon & := \{u\} =: \epsilon \shuffle u, \\
...
product
\begin{equation*}
    \shuffle : \QQ[A^*] \otimes \QQ[A^*] \to \QQ[A^*]
\end{equation*}
...
\begin{footnotesize}
\begin{equation*}
    O\left((|v_1| + |v_2|) \; \parenVectorstack{|v_1| + |v_2| \\ |v_1|}\right)
\end{equation*}
\end{footnotesize}
...
\uncover<2->{%
Given three words $u$, $v_1$, and $v_2$, deciding if $u$ is in
$v_1 \shuffle v_2$ can be done in
\begin{footnotesize}
\begin{equation*}
...
\begin{block}{{\bf Definition} (square words)}
...
\begin{block}{\bf Example}
    The word
    \begin{math}
        u := \textcolor{RoyalBlue}{\Lc}\textcolor{BrickRed}{\Lc}
        \textcolor{RoyalBlue}{\La\Lb}\textcolor{BrickRed}{\La}
        \textcolor{RoyalBlue}{\Lb}\textcolor{BrickRed}{\Lb\Lb}
    \end{math}
    is a square since $u$ can be obtained by shuffling $\Lc\La\Lb\Lb$
    with itself.
\end{block}
\medskip}
...
\uncover<4->{%
\begin{block}{Open problem \BIB{Henshall, Rampersad, Shallit}{2012}}
...
\begin{block}{{\bf Definition} (perfect matchings for words)}
...
\uncover<2->{%
\begin{block}{\bf Example}
    The word $\Lb\La\Lb\La\Lb\Lb\Lc\Lc$ admits the perfect matching \vspace{-1em}
    \begin{equation*}
    \begin{split}
    \begin{tikzpicture}[xscale=.5,yscale=.25,inner sep=1pt,node distance=1.5cm]
        \tikzstyle{Vertex}=[draw,circle,minimum size=.35cm,font=\footnotesize]
        \draw node[Vertex,fill=RoyalBlue!30](U01){$(\Lb, 1)$};
        \draw node[Vertex,fill=RoyalBlue!30,right of=U01](U02) {$(\La, 2)$};
        \draw node[Vertex,fill=RoyalBlue!30,right of=U02](U03){$(\Lb, 3)$};
        \draw node [Vertex,fill=BrickRed!30,right of=U03](U04) {$(\La, 4)$};
        \draw node [Vertex,fill=BrickRed!30,right of=U04](U05) {$(\Lb, 5)$};
        \draw node [Vertex,fill=BrickRed!30,right of=U05](U06){$(\Lb, 6)$};
        \draw node [Vertex,fill=RoyalBlue!30,right of=U06](U07){$(\Lc, 7)$};
        \draw node [Vertex,fill=BrickRed!30,right of=U07](U08){$(\Lc, 8)$};
        \draw [thick,>=latex']
...
\uncover<3->{%
\begin{block}{{\bf Definition} (inclusion-free perfect matchings)}
...
\begin{block}{{\bf Proposition} \BIB{Rizzi, Vialette}{2013}}
...
\begin{block}{\bf Example}
    The word
    \begin{math}
        \textcolor{RoyalBlue}{\Lc}\textcolor{BrickRed}{\Lc}
        \textcolor{RoyalBlue}{\La\Lb}\textcolor{BrickRed}{\La}
        \textcolor{RoyalBlue}{\Lb}\textcolor{BrickRed}{\Lb\Lb}
    \end{math}
    admits the perfect matching \vspace{-1.25em}
    \begin{equation*}
        \begin{split}
        \begin{tikzpicture}[xscale=.5,yscale=.16,inner sep=1pt,node distance=1.5cm]
            \tikzstyle{Vertex}=[draw,circle,minimum size=.35cm,font=\footnotesize]
            \draw node[Vertex,fill=RoyalBlue!30](U01){$(\Lc, 1)$};
            \draw node[Vertex,fill=BrickRed!30,right of=U01](U02) {$(\Lc, 2)$};
            \draw node[Vertex,fill=RoyalBlue!30,right of=U02](U03){$(\La, 3)$};
            \draw node[Vertex,fill=RoyalBlue!30,right of=U03](U04) {$(\Lb, 4)$};
            \draw node[Vertex,fill=BrickRed!30,right of=U04](U05) {$(\La, 5)$};
            \draw node[Vertex,fill=RoyalBlue!30,right of=U05](U06){$(\Lb, 6)$};
            \draw node[Vertex,fill=BrickRed!30,right of=U06](U07){$(\Lb, 7)$};
            \draw node[Vertex,fill=BrickRed!30,right of=U07](U08){$(\Lb, 8)$};
            \draw [thick,>=latex']
            ...
            \draw [thick,>=latex']
            (U04.south) .. controls ($ (U04.south) + (0,-2.25) $)
                and ($ (U07.south) + (0,-2.25) $) .. (U07.south);
            \draw [thick,>=latex']
    ...
    \vspace{-1.25em}
    which is inclusion-free and hence is a square.
\end{block}}

\uncover<3->{%
\begin{block}{\bf Example}
    The word $\La\Lb\Lb\La$ is not a square. Its only perfect matching\vspace{-1em}
    \begin{equation*}
        \begin{split}
        \begin{tikzpicture}[xscale=.5,yscale=.2,inner sep=1pt,node distance=1.5cm]
            \tikzstyle{Vertex}=[draw,circle,minimum size=.35cm,font=\footnotesize]
            \draw node[Vertex,fill=RoyalBlue!30](U01){$(\La, 1)$};
            \draw node[Vertex,fill=RoyalBlue!30,right of=U01](U02) {$(\Lb, 2)$};
            \draw node[Vertex,fill=BrickRed!30,right of=U02](U03){$(\Lb, 3)$};
            \draw node [Vertex,fill=BrickRed!30,right of=U03](U04) {$(\La, 4)$};
            \draw [thick,>=latex']
            (U01.north) .. controls ($ (U01.north) + (0,2) $)
                and ($ (U04.north) + (0,2) $) .. (U04.north);
            \draw [thick,>=latex']
            (U02.south) .. controls ($ (U02.south) + (0,-1.5) $)
                and ($ (U03.south) + (0,-1.5) $) .. (U03.south);
...
Let $S_n$ be the set of \alert{permutations} of size $n$ and $S$ be the
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame} \frametitle{Combinatorial products and coproducts}
Let $C$ be a set of combinatorial objects and $\QQ[C]$ be the
$\QQ$-linear span of $C$.

\uncover<2->{%
\begin{block}{Key idea}
    Knowing how to \alert{break} combinatorial objects explains
    how to \alert{combine} these.
\end{block}
\medskip}

\uncover<3->{%
To define a product $\cdot : \QQ[C] \otimes \QQ[C] \to \QQ[C]$,
it is in some cases more convenient to start by defining a \alert{coproduct}
$\Delta : \QQ[C] \to \QQ[C] \otimes \QQ[C]$.
\medskip}

\uncover<4->{%
Every coproduct fits into the general form
\begin{equation*}
    \Delta(z)
    = \sum_{x, y \in C} \textcolor{RoyalBlue}{\lambda_{x, y}^z} \;
    (x \otimes y)
\end{equation*}
where the $\textcolor{RoyalBlue}{\lambda_{x, y}^z} \in \QQ$ are structure
coefficients.
\medskip}

\uncover<5->{%
Then, $\Delta$ leads by duality to the definition of $\cdot$ by
\begin{equation*}
    x \cdot y
    := \sum_{z \in C} \textcolor{RoyalBlue}{\lambda_{x, y}^z} \; z.
\end{equation*}}
\end{frame}

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame} \frametitle{Example: unshuffling words}
Consider the coproduct
\begin{equation*}
    \Delta : \QQ[A^*] \to \QQ[A^*] \otimes \QQ[A^*]
\end{equation*}
on words defined by
\begin{equation*}
    \Delta(u) :=
...
\uncover<2->{%
\begin{block}{\bf Example}\vspace{-1.5em}
\begin{equation*}
    \textcolor{RoyalBlue}{\Delta(\Lb\La\La)} =
    \epsilon \otimes \Lb\La\La + \Lb \otimes \La\La
    + \textcolor{Orange}{2} (\textcolor{BrickRed}{\La \otimes \Lb\La})
    + 2 (\Lb\La \otimes \La) + \La\La \otimes \Lb
    + \Lb\La\La \otimes \epsilon
\end{equation*}
\end{block}}

\uncover<3->{%
\begin{block}{{\bf Proposition} \BIB{Reutenauer}{1993}}
    The shuffle product of words is the dual product of the
    unshuffling coproduct of words.
\end{block}}

\uncover<4->{%
\begin{block}{\bf Example}
Since $\textcolor{BrickRed}{\La \otimes \Lb\La}$ has
multiplicity $\textcolor{Orange}{2}$ in
$\textcolor{RoyalBlue}{\Delta(\Lb\La\La)}$, the coeff. of
$\textcolor{RoyalBlue}{\Lb\La\La}$ is
$\textcolor{Orange}{2}$ in
$\textcolor{BrickRed}{\La \shuffle \Lb\La}$:\vspace{-.9em}
\begin{equation*}
    \textcolor{BrickRed}{\La \shuffle \Lb\La} =
    \La\Lb\La + \textcolor{Orange}{2}\, \textcolor{RoyalBlue}{\Lb\La\La}.
\end{equation*}
\vspace{-1.8em}
\end{block}}
\end{frame}
...
\begin{block}{{\bf Definition} (standardization of words)}
    If $u$ is a word of integers without multiple occurrence of a same
    letter, the \alert{standardized} $\STD(u)$ of $u$ is the unique
    permutation of $S_{|u|}$ order-isomorphic to~$u$.
\end{block}
...
\uncover<3->{%
\begin{block}{{\bf Definition} (unshuffling coproduct of permutations)}
...
\vspace{-.5em}
\begin{equation*}
    \Delta(21\textcolor{BrickRed}{3}) =
    \epsilon \otimes 213 +
    \textcolor{Orange}{2} (1 \otimes 1\textcolor{BrickRed}{2}) +
...
\begin{block}{{\bf Definition} (shuffling product of permutations)}
...
\uncover<3->{%
\begin{block}{\bf Example}\vspace{-1em}
\begin{equation*}\begin{split}
    \textcolor{RoyalBlue}{12} \SHUFFLE \textcolor{BrickRed}{21} & =
    \textcolor{RoyalBlue}{12}\textcolor{BrickRed}{43} +
    \textcolor{RoyalBlue}{1}\textcolor{BrickRed}{32}\textcolor{RoyalBlue}{4}
    + 2 (\textcolor{RoyalBlue}{1}34\textcolor{BrickRed}{2}) +
    2 (1423) + 3 (1432) +
    2134 + 2 (2314) \\[.4em]
...
The first numbers of square permutations of size $2n$ are
\begin{equation*}
    1, 2, 20, 504, 21032, 1293418.
\end{equation*}

\uncover<2->{%
Square permutations are compatible with some involutions on permutations:
\begin{block}{\bf Proposition}
...
\uncover<3->{%
There is a link with square binary words:
\begin{block}{\bf Proposition}
...
\begin{frame}
\frametitle{Pattern involvement problem}

  \begin{block}{{\bf Definition} (permutation patterns)}
...
\uncover<2->{%
  \begin{block}{\bf Example}
        The permutation
        $\pi = 3\textcolor{RoyalBlue}{91}8\textcolor{RoyalBlue}{674}52$
        contains the pattern $\sigma := 51342$ since
        $\STD(\textcolor{RoyalBlue}{91674}) = 51342$.
  \end{block}
  \medskip}

\uncover<3->{%
  \begin{block}{{\bf Definition} (pattern involvement problem)}
    The \alert{pattern involvement problem} is the decision problem
    consisting in, given $\pi, \sigma \in S$, decide
    whether~$\sigma \leq \pi$.
  \end{block}}

\uncover<4->{%
  \begin{block}{{\bf Proposition} \BIB{Bose, Buss, Lubiw}{1998}}
...
\begin{frame}
  \frametitle{Recognizing square permutations}
    ...
    \begin{block}{{\bf Definition} (perfect matchings for permutations)}
...
\uncover<2->{%
  \begin{block}{{\bf Definition} (property $\mathbf{P_1}$)}
...
\uncover<3->{%
  \begin{block}{{\bf Definition} (property $\mathbf{P_2}$)}
    Let $\pi \in S$. A perfect matching $(V, A)$ of $\pi$ has property
...
\uncover<2->{%
  \begin{block}{Main ideas of the proof}
    \begin{itemize}
        ...
        in polynomial time to the problem of deciding if a permutation
        is a square.
        \medskip
        ...
        \uncover<4->{%
        \item We use the fact that $\mu_{\sigma, \pi}$ is a square iff
        $\mu_{\sigma, \pi}$ admits a perfect matching satisfying
...
\begin{frame}
  ...
  \begin{block}{Combinatorics}
        Enumeration of square permutations?
  \end{block}
  \medskip
