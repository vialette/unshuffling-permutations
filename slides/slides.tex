...
\begin{equation*}
    \Delta(100) =
    \epsilon \otimes 100 + 1 \otimes 00
    + \textcolor{BrickRed}{2 (0 \otimes 10)} + 2 (10 \otimes 0) + 00 \otimes 1
    + 100 \otimes \epsilon
\end{equation*}
\smallskip

Since $0 \otimes 10$ has multiplicity $2$ in $\Delta(100)$, by duality,
$100$ has multiplicity $2$ in $0 \shuffle 10$:
\begin{equation*}
    0 \shuffle 10 = 010 + \textcolor{BrickRed}{2 (100)}.
\end{equation*}
\end{block}
\end{frame}
...
This shuffle product has been introduced for the study of some
Hopf algebra \BIB{Vargas}{2014}.
\medskip

It is a kind of association of the convolution product and the shifted
shuffle product of permutations \BIB{Duchamp, Hivert, Thibon}{2002}.
\end{frame}
