...
\begin{proof}
  ...
  Combine Claim~\ref{claim:one (nu_1, nu'_1)-edge} with
  ...
  \begin{proof}[of Claim~\ref{claim: all (nu_1, nu'_1)-edges}]
    ...
    Claim~\ref{claim:no edge below one (nu_2, nu'_2)-edge},
  ...
  \begin{claim}
    \label{claim:no (nu_1, nu_3)-edge no (nu'_1, nu_3)-edge no (nu_1, nu_4)-edge}
    There is neither a $(\nu_1, \nu_3)$-edge nor a $(\nu'_1, \nu_3)$-edge
    nor a $(\nu_1, \nu_4)$-edge
    in $\mathcal{M}$.
  \end{claim}

  \begin{proof}[of Claim~\ref{claim:no (nu_1, nu_3)-edge no (nu'_1, nu_3)-edge no (nu_1, nu_4)-edge}]
    According to Claim~\ref{claim: all (nu_1, nu'_1)-edges},
    all positions in $\nu_1$ and $\nu'_1$ are involved in
    $(\nu_1, \nu'_1)$-edges in $\mathcal{M}$.
    \qed
  \end{proof}
  ...
  \begin{claim}
    \label{claim:no (pi', pi)-edge no (sigma', pi'')-edge no (sigma',sigma'')-edge}
    There is
  ...
  \begin{proof}[of Claim~\ref{claim:no (pi', pi)-edge no (sigma', pi'')-edge no (sigma',sigma'')-edge}]
    Combine Claim~\ref{claim:one (nu_4, nu'_4)-edge} with the
    fact that $\mathcal{M}$ is containment-free.
    \qed
  \end{proof}

  Then it follows that that every position in $\sigma$ is involved in
  either a $(\sigma', \nu'_3)$-edge
  or a $(\sigma', \pi')$-edge
  or a $(\sigma', \nu'_4)$-edge
  in $\mathcal{M}$.
