...
endowing the space of all permutations with a coalgebra structure
...
that are square are in one-to-one bijection with square permutations
...
\NPC (Proposition~\ref{proposition:hardness}).
...
\begin{proof}[of Proposition~\ref{prop:square_stability}]
    ...
    $\rho \SHUFFLE \rho$. Now, by Lemma~\ref{lem:endomorphisms},
