...
\begin{proof}
  ...
  \begin{claim}
    \label{claim:no edge below one (nu_2, nu_2)-edge}
    There is
    neither a $(\nu'_1, \nu'_1)$-edge,
    nor a $(\nu'_1, \nu_3)$-edge,
    nor a $(\nu'_1, \sigma')$-edge,
  ...
  \begin{proof}[of Claim~\ref{claim:no edge below one (nu_2, nu_2)-edge}]
    Combine Claim~\ref{claim:one (nu_2, nu'_2)-edge} together with the fact that
  ...
  \begin{proof}[of Claim~\ref{claim: all (nu_1, nu'_1)-edges}]
    ...
    Claim~\ref{claim:no edge below one (nu_2, nu_2)-edge},
    ...
    Furthermore, according to Claim~\ref{claim:one (nu_1, nu'_1)-edge},
    there exists a $(\nu_1, \nu'_1)$-edge in $\mathcal{M}$.
    Then, we have
    $\mu(x) < \mu(a)$ (since $\nu_1$ is below $\nu'_1$) and
    $\mu(x') < \mu(a')$ (since $\nu'_1$ is above any other gadget),
  ...
  \begin{proof}[of Claim~\ref{claim: all (nu_2, nu'_2)-edges}]
    Suppose, aiming at a contradiction, that
    $\mathcal{M}$ does not contain $N_2$ $(\nu_2, \nu'_2)$-edge.
    According to Claim~\ref{claim:one (nu_2, nu'_2)-edge},
    there exists a $(\nu_2; \nu'_2)$-edge $(a, a')$ in $\mathcal{M}$.
    Combing Claim~\ref{claim:no (nu_1, nu_2)-edge},
    Claim~\ref{claim:no (nu_2, nu'_1)-edge}  and
    Claim~\ref{claim:one (nu_2, nu'_2)-edge},
    we conclude that there exists a position $x$ in $\nu_2$ that is
    involded in an edge $(x, x')$ in $\mathcal{M}$ that is
    neither a $\nu_1, \nu_2)$-edge,
    nor a $(\nu_2, \nu_2)$-edge,
    nor a $(\nu_2, \nu'_1)$-edge
    nor a $(\nu_2, \nu'_2)$-edge (our hypothesis).
    ...
    \begin{itemize}
      ...
      $\mu(a) > \mu(x)$ (since $\nu_2$ is decreasing) and
      $\mu(a') < \mu(x')$
      (since $\nu'_3$, $\pi'$, $\nu'_4$, $\pi''$ and $\sigma''$ are all above
      $\nu'_2$),
      which contradicts our hypothesis.
      \item
      $(x, x')$ is
      ...
      or a $(\nu_2, \nu_4)$-edge.
    \end{itemize}
    Furthermore, according to Claim~\ref{claim:one (nu_2, nu'_2)-edge},
    there exists a $(\nu_1, \nu'_1)$-edge in $\mathcal{M}$.
    Then, we have
    $\mu(x) < \mu(a)$ (since $\nu_1$ is below $\nu'_1$) and
    $\mu(x') < \mu(a')$ (since $\nu'_1$ is above any other gadget),
  ...
  \begin{proof}[of Claim~\ref{claim:no (nu_1, nu_3)-edge no (nu'_1, nu_3)-edge}]
    ...
    and since $\mathcal{M}$ is containment-free we have $x < a$.
    Therefore, we have
    $\mu(x) < \mu(a)$ (since $\nu_1$ is increasing)
    and
    $\mu(x') > \mu(a')$ (since $\nu'_1$ is above $\nu_3$),
    ...
    The same argument shows that there is no
  ...
  \begin{proof}[of Claim~\ref{claim:one (nu_3, nu'_3)-edge}]
    Suppose, aiming at a contradiction, that there is no
    $(\nu_3, \nu'_3)$-edge in $\mathcal{M}$.
    Combining Claim~\ref{claim:no (nu_1, nu_3)-edge no (nu'_1, nu_3)-edge},
    Claim~\ref{claim:no edge below one (nu_2, nu_2)-edge},
    Claim~\ref{claim:at most one (nu_2, nu_3)-edge},
    and Claim~\ref{claim:no (nu_3, nu'_2)-edge},
  ...
  \begin{claim}
    \label{claim:no (nu_1, nu_4)-edge}
    There is no $(\nu_1, \nu_4)$-edge in $\mathcal{M}$.
  \end{claim}

  \begin{proof}[of Claim~\ref{claim:no (nu_1, nu_4)-edge}]
    Suppose, aiming at a contradiction, that there exists
    a $(\nu_1, \nu_4)$-edge $(a, b)$ in $\mathcal{M}$.
    According to Claim~\ref{claim:one (nu_1, nu'_1)-edge},
    there exists a $(\nu_1, \nu'_1)$-edge $(x, x')$
    in $\mathcal{M}$.
    Since $\mathcal{M}$ is containment-free, we must have $x < a$.
    Therefore, we have
    $\mu(x) < \mu(a)$ (since $\nu_1$ is incresing)
    and $\mu(x') > \mu(a')$ since $\nu'_1$ is above $\nu_4$),
    which contradicts our hypothesis.
  ...
  \begin{proof}[of Claim~\ref{claim:no (nu_4, nu'_3)-edge}]
    ...
    According to Claim~\ref{claim:one (nu_3, nu'_3)-edge},
    there exists a $(\nu_3, \nu'_3)$-edge $(x, x')$
    in $\mathcal{M}$.
  ...
  \begin{proof}[of Claim~\ref{claim:one (nu_4, nu'_4)-edge}]
    ...
    $(\nu_4, \nu'_4)$-edge in $\mathcal{M}$.
    Combining
    Claim~\ref{claim:no (nu_1, nu_4), (nu'_1, nu_4)-edge}
    Claim~\ref{claim:no edge below one (nu_2, nu_2)-edge}
    Claim~\ref{}
    \qed
  \end{proof}
