    ...
    \begin{figure}[t!]
      \centering
        \begin{tikzpicture}
          ...
          \draw[step=1cm,black!30,ultra thin,fill=black!10] (0.8,16.8) grid (5.2,21.2);
          \foreach \x/\y in {1/20,2/19,3/17,4/18,5/21} {
              \draw [fill=black] (\x,\y) circle (0.1);
          }
          \node (pip) at (2.5,16) {$\sigma'$};
          % pi'
          \draw [cell,rounded corners] (6.5,8.5) -- (12.5,8.5) -- (12.5,14.5) -- (6.5,14.5) -- cycle;
          \draw[step=1cm,black!30,ultra thin,fill=black!10] (5.8,8.8) grid (13.2,16.2);
          ...
          \draw[step=1cm,black!30,ultra thin,fill=black!10] (13.8,2.8) grid (19.2,8.2);
          \foreach \x/\y in {14/6,15/7,16/4,17/3,18/5,19/8} {
              \draw [fill=black] (\x,\y) circle (0.1);
          }
          \node (pipp) at (16.75,2) {$\pi''$};
          % sigma''
          \draw [cell,rounded corners] (19.5,-0.5) -- (22.5,-.5) -- (22.5,2.5) -- (19.5,2.5) -- cycle;
          \draw[step=1cm,black!30,ultra thin,fill=black!10] (19.8,-0.2) grid (22.2,2.2);
          \foreach \x/\y in {20/2,21/0,22/1} {
              \draw [fill=black] (\x,\y) circle (0.1);
          }
          \node (sigmapp) at (20.5,-1) {$\sigma''$};
          % edges sigma' - pi'
          \draw [line width=1pt]
          ...
          \node[%
            ...
            rectangle callout,callout relative pointer={(0cm,-.75cm)}
          ] at (1,28)
          {%
          ...
          \node[%
            draw,
            text width=5.5cm,text justified,color=black!50,
            rectangle callout,callout relative pointer={(-0.75cm,-0.5cm)}
          ] at (17,24)
          {%
          $n-k=|\pi|-|\sigma|$ pairwise crossing $(\sigma',\pi')$-edges that
          ...
          {%
          $k=|\sigma|$ pairwise crossing $(\sigma',\pi')$-edges that
          ...
          {%
          $k=|\sigma|$ pairwise crossing $(\pi''; \sigma'')$-edges that
          denote a specific occurence of $\sigma$ in $\pi$
          (at positions $2$, $3$ and $5$).
          };%
        \end{tikzpicture}
