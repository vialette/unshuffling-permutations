...
\begin{proof}
  ...
  \begin{claim}
    \label{claim:no edge below one (nu_2, nu'_2)-edge}
    There is
    neither a $(\nu'_1, \nu'_1)$-edge,
    nor a $(\nu'_1, \nu_3)$-edge,
    nor a $(\nu'_1, \sigma')$-edge,
  ...
  \begin{proof}[of Claim~\ref{claim:no edge below one (nu_2, nu'_2)-edge}]
  ...
  \begin{claim}
    \label{claim:one (nu_1, nu'_2)-edge}
    There is no $(\nu_1, \nu'_2)$-edge in $\mathcal{M}$.
  \end{claim}

  \begin{proof}[of Claim~\ref{claim:one (nu_1, nu'_2)-edge}]
  ...
  \begin{claim}
    \label{claim:one (nu'_1, nu'_2)-edge}
    There is no $(\nu'_1, \nu'_2)$-edge in $\mathcal{M}$.
  \end{claim}

  \begin{proof}[of Claim~\ref{claim:one (nu'_1, nu'_2)-edge}]
    Suppose, aiming at a contradiction that there is a
    $(\nu'_1, \nu'_2)$-edge $(a, a')$ in $\mathcal{M}$.
    According to Claim~\ref{claim:one (nu_1, nu'_1)-edge},
    there exists a $(\nu_1, \nu'_1)$-edge $(b, b')$ in $\mathcal{M}$.
  ...
  \begin{proof}[of Claim~\ref{claim:no edge below one (nu_3, nu'_3)-edge}]
    Combine Claim~\ref{claim:one (nu_3, nu'_3)-edge} with the fact that
    $\mathcal{M}$ is containment-free.
    \qed
  \end{proof}
  ...
  \begin{proof}[of Claim~\ref{claim:no (pi', pi')-edge}]
    Combine Claim~\ref{claim:one (nu_4, nu'_4)-edge} together with the
  ...
  \begin{proof}[of Claim~\ref{claim:no (nu'_3, pi')-edge}]
    Suppose aiming at a contradiction that there exists
    a $(\nu'_3, \pi')$-edge $(a, a')$ in $\mathcal{M}$.
    Accordint to Claim~\ref{claim:one (nu_3, nu'_3)-edge},
    there exists a $(\nu_3, \nu'_3)$-edge $(b, b')$ in $\mathcal{M}$.
    Then it follows that we have
    $\mu(b) < \mu(a)$ (since $\nu_3$ is below $\nu'_3$) and
    $\mu(b') > \mu(a')$ (since $\nu'_3$ is above $\pi'$),
    which contradicts our hypothesis.
