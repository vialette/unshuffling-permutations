...
We mention several -~ñot necessarily new~- open problems that are, in our opinion,
the most interesting.
How many permutations of $S_{2n}$ are squares?
How many $(213,231)$-avoiding permutations of $S_{2n}$ are squares?
(Equivalentely, how many strings in $\{0,1\}^{2n}$ are squares;
see Problem~4 in \cite{Henshall:Rampersad:Shallit:2011})?
How are is the problem of deciding whether whether a $(213,231)$9avoiding permutation
